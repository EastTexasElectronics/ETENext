...
const Page = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 shadow-lg rounded-lg flex flex-col items-center text-center">
      ...
      <p className="mb-3">
        Join our team of professionals who are dedicated to providing the best services to our clients. Discover how you
        can contribute to our ongoing success and grow your career with us.
      </p>
