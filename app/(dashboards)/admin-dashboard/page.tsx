    ...
    <body className="bg-gray-50">
      <header className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">SafariHR</h1>
        </div>
      </header>
      <div className="min-h-full">
        ...
        <div className="bg-blue-300 flex justify-between">
          ...
          <div className="bg-blue-300 max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-sans tracking-tight text-gray-900">Charlot Daniel Abbot</h1>
