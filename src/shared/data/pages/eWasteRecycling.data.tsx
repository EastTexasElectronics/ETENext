...
import recyclingHero from '~/assets/images/recyclingHero.png';
...
// Hero data on Recycling page
export const heroRecycling: HeroProps = {
...
// Features data on Recycling page
export const features2Recycling: FeaturesProps = {
  columns: 3,
  header: {
...
// Content data on Recycling page for Data Privacy
export const contentRecyclingOne: ContentProps = {
...
// Content data on Repair page for Recycling Standards
export const contentRecyclingTwo: ContentProps = {
...
// FAQs data on Recycling page
export const faqsRecycling: FAQsProps = {
  hasBackground: true,
  columns: 1,
  header: {
...
// Call to Action data on Recycling page
export const callToActionRecycling: CallToActionProps = {
  hasBackground: false,
