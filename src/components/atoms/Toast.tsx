                    ...
                    {open1 && (
                        <div className="bg-white cursor-pointer shadow rounded-lg px-3 py-2 w-64 space-y-2">
                            ...
                            <div className="flex justify-between items-center w-full">
                                ...
                                <div onClick={() => setOpen1(!open1)} className="h-6 w-6 flex justify-center items-center bg-gray-200 rounded-full cursor-pointer hover:bg-gray-300">
                                ...
                                <div className="flex flex-col h-20 overflow-hidden">
                                    <div className="overflow-ellipsis overflow-hidden text-sm">
                                        <div className="leading-tight ">
                                            <b className="font-semibold">Hasan Muhammad</b> Menambahkann 2 foto di <b className="font-semibold">Tailwind CSS Indonesia</b>
                                        </div>
                                    </div>
                    ...
                    {open2 && (
                        <div className="bg-white cursor-pointer shadow rounded-lg px-3 py-2 w-64 space-y-2">
                            ...
                            <div className="flex justify-between items-center w-full">
                                ...
                                <div onClick={() => setOpen2(!open2)} className="h-6 w-6 flex justify-center items-center bg-gray-200 rounded-full cursor-pointer hover:bg-gray-300">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                                </div>
                            </div>
                            {/* Content */}
