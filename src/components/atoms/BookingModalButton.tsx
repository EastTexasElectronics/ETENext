  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-0 top-1/2 z-50 p-2 bg-primary-600 hover:bg-primary-500 text-white font-bold pt-1.5 pb-1 pl-0.5 transform -transecondary-y-1/2 shadow-lg cursor-pointer rounded-tl-lg rounded-bl-lg text-xs transition duration-300 ease-in-out hover:scale-105"
      >
