        ...
        >
          <div className={classCollapseItem}>
            <div
              ...
              role="button"
            >
              <h2 className="w-full pr-2 text-lg font-medium leading-6 text-gray-900 dark:text-secondary-300">{title}</h2>
              {iconDown && iconUp ? (
                activeIndex === index ? (
                  iconUp
                ) : (
            ...
            {activeIndex === index && (
              ...
              >
                <p className="mt-2 text-gray-600 dark:text-secondary-400">{description}</p>
              </div>
            )}
          </div>
        </div>
