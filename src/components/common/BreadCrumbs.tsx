                ...
                <ol className="flex w-auto items-center gap-2 rounded-md bg-secondary-200 px-4 py-2 shadow-md">
                    ...
                    <li className="inline-flex">
                        <div className="flex items-center gap-2 text-lg font-medium opacity-60">
                            <span>/ </span>
                            <a href="" className="transition-all duration-300 hover:text-blue-600"> My Courses </a>
                        </div>
                    </li>
                    <li className="inline-flex">
                        <div className="flex items-center gap-2 text-lg font-medium opacity-60">/ <a href="" className="transition-all duration-300 hover:text-blue-600"> Course Name </a></div>
                    </li>
                    <li className="inline-flex">
                        <div className="flex items-center gap-2 text-lg font-medium opacity-60">
                            /
                            <a href="" className="transition-all duration-300 hover:text-blue-600"> Resources </a>
                        </div>
                    </li>
                    <li className="inline-flex">
                        <div className="flex cursor-pointer items-center gap-2 text-lg hover:text-blue-600">/ Icon</div>
                    </li>
                </ol>
            </div>
        </div>
