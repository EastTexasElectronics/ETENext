...
import { DigitalAssetsProps } from '~/shared/types';
  ...
  return (
    <div className="dark:bg-slate-800 dark:text-white p-4 rounded-lg shadow-lg space-y-4">
      <div className=" justify-between items-center">
        <h1 className="text-2xl font-bold shadow">Your Digital Assets</h1>
        <p>Below you will find assets we are assiting you with for safety reason we can not provide password through this dashboard. </p>
      </div>
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold shadow">Your Digital Assets</h1>
        <p>Feel free to use the edit button to the right to store any URLS or text you may want to store here for reference.  PLEASE DO NOT STORE PASSWORDS OR OTHER SENSITIVE DATA HERE.  </p>
